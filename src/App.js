            ...
            <div className="header">
                <div className="container">
                    <div className="header__logo">
                        ...
                        <div>
                            <h1>Burgers shop</h1>
                            <p>Бургер - это тот же бутерброд, только другой</p>
                        </div>
                    </div>
                    ...
                    <div className="content__items">
                        <div className="burger-block">
                            <img
                                ...
                                src="https://mcdonalds-a.akamaihd.net/product/f4de5ec867af41a3896019701eb18820/android/l/main.png"
                                alt="burger"
                            />
                            <h4 className="burger-block__title">Чизбургер</h4>
                            ...
                            <div className="burger-block__bottom">
                                <div className="burger-block__price">от 49 ₽</div>
